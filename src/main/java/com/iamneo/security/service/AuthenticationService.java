...
public class AuthenticationService {
	...
	public boolean authorizeinfo(String pname,String pwd) {
		Optional<User> user1=userRepository.findByEmail(pname);
		String encodedInputPwd = passwordEncoder.encode(pwd);
		System.out.println(encodedInputPwd);
		System.out.println(pwd);
		System.out.println(user1);
//		if(user1.isPresent() && user1.get().getUsername().equals(pname) && user1.get().getPassword().equals(encodedInputPwd)) {
//			return true;
//		}
//		else {
//			return false;
